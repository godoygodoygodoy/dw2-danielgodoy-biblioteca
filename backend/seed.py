...
books = [
    ...
    {"titulo": "Turma da Mônica: Lições de Vida (HQ)", "autor": "Mauricio de Sousa", "ano": 2000, "genero": "HQ", "isbn": "", "status": "disponível"},
    {"titulo": "Asterix e Obelix (HQ)", "autor": "René Goscinny", "ano": 1965, "genero": "HQ", "isbn": "", "status": "disponível"},
    {"titulo": "O Pequeno Príncipe (HQ)", "autor": "Antoine de Saint-Exupéry", "ano": 1943, "genero": "HQ", "isbn": "", "status": "disponível"},
    {"titulo": "O Senhor dos Anéis: A Sociedade do Anel (HQ)", "autor": "J.R.R. Tolkien", "ano": 1954, "genero": "HQ", "isbn": "", "status": "disponível"},
    {"titulo": "Sherlock Holmes: Um Estudo em Vermelho (HQ)", "autor": "Arthur Conan Doyle", "ano": 1887, "genero": "HQ", "isbn": "", "status": "disponível"},
    ...
    {"titulo": "Os Miseráveis (HQ)", "autor": "Victor Hugo", "ano": 1862, "genero": "HQ", "isbn": "", "status": "disponível"},
    {"titulo": "O Mundo de Sofia (HQ)", "autor": "Jostein Gaarder", "ano": 1991, "genero": "HQ", "isbn": "", "status": "disponível"},
    ...
    {"titulo": "Harry Potter e a Pedra Filosofal (HQ)", "autor": "J.K. Rowling", "ano": 1997, "genero": "HQ", "isbn": "", "status": "disponível"},
]
